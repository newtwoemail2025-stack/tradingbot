...
const DATA_DIR = path.join(__dirname, '../data/phase33c');
...
const runId = `phase33c-run-${Date.now()}`;
...
console.log("Starting Phase 33C - Real 60-Minute Validation...");
...
// Run for 60 minutes (3,600,000 ms)
...
setTimeout(() => {
    ...
    const summary = {
        ...
        uniqueSnapshots: snapshotHashes.size,
        duplicateSnapshots: totalSnapshots - snapshotHashes.size,
        reconnectCount: reconnects,
        totalTrades: trades.length,
        closedTrades: closedTrades.length,
        longTrades: longCount,
        shortTrades: shortCount,
        tradesPerHour: trades.length,
        tpCount,
        slCount,
    ...
    const metadata = {
        ...
        exchange: 'CoinDCX',
        symbol: 'B-SOL_USDT',
        strategyVersion: 'Phase 33C Real Validation',
    ...
    console.log("Phase 33C data collection finished.");
    process.exit(0);
}, DURATION_MS);
