...
const DATA_DIR = path.join(__dirname, '../data/phase33b');
...
const runId = `phase33b-run-${Date.now()}`;
...
console.log("Starting Phase 33B - Real 30-Minute Validation...");
...
// Run for 30 minutes (1,800,000 ms)
...
setTimeout(() => {
    ...
    const metadata = {
        ...
        exchange: 'CoinDCX',
        symbol: 'B-SOL_USDT',
        strategyVersion: 'Phase 33B Real Validation',
    ...
    console.log("Phase 33B data collection finished.");
    process.exit(0);
}, DURATION_MS);
