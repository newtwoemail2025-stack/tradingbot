...
const DATA_DIR = path.join(__dirname, '../data/phase33f');
...
const runId = `phase33f-run-${Date.now()}`;
...
console.log("Starting Phase 33F - Real 30-Minute Validation...");
...
setTimeout(() => {
    ...
    const metadata = {
        ...
        exchange: 'CoinDCX',
        symbol: 'B-SOL_USDT',
        strategyVersion: 'Phase 33F High-Freq Validation',
    ...
    console.log("Phase 33F data collection finished.");
    process.exit(0);
}, DURATION_MS);
